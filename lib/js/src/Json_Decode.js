  ...
  while(true) {
    ...
    switch (error.TAG | 0) {
      case /* Failure */0 :
          ...
          var intro = reveresed ? "Problem with the value at json" + joinList(reveresed, "") : "Problem with the given value:\n\n";
